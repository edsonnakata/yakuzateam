...
class ScenesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scene" do
    assert_difference('Scene.count') do
      post scenes_url, params: { scene: { history_id: @scene.history_id, imagem: @scene.imagem } }
    end
  ...
  test "should update scene" do
    patch scene_url(@scene), params: { scene: { history_id: @scene.history_id, imagem: @scene.imagem } }
