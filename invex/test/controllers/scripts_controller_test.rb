...
class ScriptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create script" do
    assert_difference('Script.count') do
      post scripts_url, params: { script: { history_id: @script.history_id, titulo: @script.titulo, user_id: @script.user_id } }
    end
  ...
  test "should update script" do
    patch script_url(@script), params: { script: { history_id: @script.history_id, titulo: @script.titulo, user_id: @script.user_id } }
